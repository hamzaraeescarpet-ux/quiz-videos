...
export default function Blog() {
  return (
    <div className="space-y-10 animate-in fade-in duration-500 py-8">
      ...
      <header className="px-2 flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-dark-700">
        ...
        {/* Product Hunt Badge */}
        <div className="flex-shrink-0 bg-dark-800 border border-dark-700/60 p-4 rounded-xl flex items-center justify-between gap-4 max-w-sm">
          <div className="text-xs space-y-1">
            <h4 className="font-bold text-white">We are on Product Hunt! 🚀</h4>
            <p className="text-gray-400">Support our launch and check us out!</p>
          </div>
          <a 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {blogPosts.map((post) => (
          <article 
            key={post.slug}
            className="bg-dark-800/40 border border-dark-700/60 rounded-2xl overflow-hidden flex flex-col justify-between hover:border-brand-500/50 hover:shadow-xl hover:shadow-brand-500/5 transition-all duration-300 group"
          >
            <div>
              {/* Blog Image */}
              ...
              <div className="p-6 space-y-4">
                ...
                {/* Title */}
                <h2 className="text-xl font-bold text-gray-100 group-hover:text-brand-400 transition-colors line-clamp-2">
